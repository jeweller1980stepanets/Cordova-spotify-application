...
import com.spotify.sdk.android.authentication.WebAuthResultActivity;
    ...
    public void onPlaybackEvent(PlayerEvent playerEvent) {
      mMetaData = currentPlayer.getMetadata();
        ...
        if(playerEvent.name().equals(EVENT_NOTIFY_PAUSE)){
            ...
            sendUpdate(EVENT_AUDIO_FLASH, new Object[]{array});
            ...
            sendUpdate(EVENT_TRACK_CHANGED, new Object[]{array});
